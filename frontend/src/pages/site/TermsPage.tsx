...
export const TermsPage: React.FC = () => {
  useSeo({
    ...
    description: 'Terms of use for the DEVOS v1.0.0 developer workspace.',
    canonicalPath: '/terms',
  });
  ...
  return (
    <div className="site-narrow">
      ...
      <div className="site-card" style={{ marginBottom: 'var(--space-4)' }}>
        <h3>The service</h3>
        <p>
          DEVOS v1.0.0 provides a project-scoped developer workspace: file management, a sandboxed terminal,
      ...
      <div className="site-card" style={{ marginBottom: 'var(--space-4)' }}>
        ...
        <p>
          ...
          you create or upload. Do not upload content you have no right to share. Do not use DEVOS v1.0.0 to attack
      ...
      <div className="site-card" style={{ marginBottom: 'var(--space-4)' }}>
        ...
        <p>
          AI-generated responses may be wrong. When no provider key is configured, DEVOS v1.0.0 runs in a clearly
      ...
      <div className="site-card">
        <h3>Liability</h3>
        <p>
          DEVOS v1.0.0 is provided without warranty to the extent permitted by law. Keep backups of important work;
