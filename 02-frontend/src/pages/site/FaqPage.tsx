...
const FAQS: { q: string; a: string }[] = [
  {
    q: 'What is DEVOS?',
    a: 'DEVOS is a project-aware AI developer workspace. Each project gets an isolated workspace with a file explorer, code viewer, sandboxed terminal, Git integration, GitHub connection, a testing center, and an AI assistant that uses your project context.',
  },
  {
  ...
  },
  {
    ...
    a: 'DEVOS falls back to a clearly labelled Local/Mock mode. Responses are deterministic development placeholders and are visibly marked as mock in both the API and the UI — they are never presented as real model output.',
  },
  {
  ...
  {
    q: 'Does DEVOS use cookies?',
    a: 'No. Authentication uses a bearer token stored in your browser local storage, so DEVOS sets no cookies and requires no consent banner by default. A consent control only appears if an administrator configures the optional analytics endpoint.',
  },
];
...
export const FaqPage: React.FC = () => {
  useSeo({
    title: 'FAQ',
    description: 'Answers about DEVOS: files and upload, GitHub connection, AI providers and mock mode, terminal allowlist, privacy, and cookies.',
    canonicalPath: '/faq',
  });
