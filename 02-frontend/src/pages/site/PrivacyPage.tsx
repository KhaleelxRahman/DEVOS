...
export const PrivacyPage: React.FC = () => {
  useSeo({
    ...
    description: 'What data DEVOS stores, how authentication works, and how optional analytics is handled.',
  ...
  return (
    <div className="site-narrow">
      ...
      <div className="site-card" style={{ marginBottom: 'var(--space-4)' }}>
        <h3>Cookies</h3>
        <p>
          DEVOS sets no cookies. Authentication uses a bearer token kept in your browser's local storage.
      ...
      <div className="site-card" style={{ marginBottom: 'var(--space-4)' }}>
        ...
        <p>
          DEVOS never reads arbitrary files from your computer — only files you explicitly create, upload, or import
