# DEVOS v1.0.0 Documentation

- [Architecture](./architecture/ARCHITECTURE.md)

- [API overview](./architecture/API.md)

- [Detailed API specification](./architecture/API_SPECIFICATION.md)
...
- [Getting started and product specifications](./getting-started/13_USER_MANUAL.md)
...
superseded by the focused guides above:

- [Legacy deployment specification](./deployment/DEPLOYMENT_LEGACY.md)

- [Legacy security specification](./security/SECURITY_LEGACY.md)
